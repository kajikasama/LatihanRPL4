 ...
 */
public class kotadialog extends javax.swing.JDialog {

    /**
     * Creates new form kotadialog
     */
    public kotadialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
...
//        kt.show();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(kotadialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                kotadialog dialog = new kotadialog(new javax.swing.JFrame(), true);
