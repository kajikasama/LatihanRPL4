 ...
 */
public class sekolahdialog extends javax.swing.JDialog {

    /**
     * Creates new form sekolahdialog
     */
    public sekolahdialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loaddatacombobox();
    }
...
//        loaddatasekolah();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sekolahdialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                sekolahdialog dialog = new sekolahdialog(new javax.swing.JFrame(), true);
